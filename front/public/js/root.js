...
const socket = io.connect("http://3.38.214.112:3000", {
    path: "/socket.io",
    transports: ["websocket"],
})
const notify2 = io.connect(`http://3.38.214.112:3000/notify`, {
    path: "/socket.io",
    transports: ["websocket"],
})
...
const gnbfunction = async (e) => {
    ...
    location.href = `http://3.38.214.112:3005${e.target.pathname}`
